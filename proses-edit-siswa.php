            ...
            <form action="proses-update-data-siswa.php" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-2">
                    ...
                    <select name="jurusan" class="form-control" required>
                        ...
                        <option value="MP" <?php if($data['jurusan'] == 'MP') echo 'selected'; ?>>Manajemen Perkantoran</option>
                        <option value="AKL" <?php if($data['jurusan'] == 'AKL') echo 'selected'; ?>>Akuntansi</option>
                        <option value="BDP" <?php if($data['jurusan'] == 'BDP') echo 'selected'; ?>>Bisnis Daring Dan Pemasaran</option>
                    </select>
                </div>
                <div class="mb-2">
