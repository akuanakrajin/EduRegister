...
<head>
	...
	<title>PPDB Online SMK 1 Triple "J"</title>
...
<body>
		<div class="container-md shadow-sm p-3 mb-5 bg-body-tertiary rounded mt-5 mb-5">
			<div class="row justify-content-center">
				<img src="img/logo-tj.png" alt="Deskripsi gambar" class="img-fluid mb-2" style="width: 150px;">
		</div>
		<div class="row justify-content-center">
			<h4 class="mb-4" style="text-align: center;">Formulir Pendaftaran Siswa Baru <br> SMK 1 Triple "J" 2024/2025</h4>
		</div>
		<div id="nisn-result">
</div>
